...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-print:hover { background: linear-gradient(135deg,#1b5e20,#2e7d32); transform:translateY(-1px); }
        .btn-reset {
        ...
        @media print {
            ...
            .container { box-shadow: none; border: 1px solid #333; max-width: 100%; }
...
<body>
    ...
    <div class="controls" id="controls">
        ...
        <button class="btn btn-print" onclick="printForm()">🖨️ طباعة</button>
